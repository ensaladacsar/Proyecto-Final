<!-- Hay que cambiar el campo de "Usuario" en el formulario para que en lugar de recoger un username
    coja un correo electrónico -->
...
<head>
    ...
    <title>Iniciar Sesión - Peluquería MelenArte</title>
    ...
    <style>
        ...
        /* Caja con mismo estilo del formulario de registro */
        .login-box {
            background: #f8f9fa;
            border-radius: 15px;
            padding: 2rem;
...
<body>
    ...
    <main class="container d-flex justify-content-center">
        <div class="login-box">
            <h3 class="text-center mb-3">Centro de miembros</h3>
            ...
            <form action="verificarUsuario.php" method="POST">
                ...
                <div class="mb-3 position-relative">
                    ...
                    <input type="text" name="correo" class="form-control input-field" placeholder="Email" required>
                </div>

                <div class="mb-3 position-relative">
                    <i class="fa fa-lock input-icon"></i>
                    <input type="password" name="contraseña" class="form-control input-field" placeholder="Contraseña" required>
                </div>

                <button type="submit" class="btn btn-login">Ingresar</button>

                <a href="./registro.php" class="register-link">¿No tienes una cuenta?<br>Regístrate aquí</a>
            </form>
        </div>
    </main>
